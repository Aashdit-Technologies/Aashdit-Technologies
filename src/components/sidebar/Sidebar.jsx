...
const Sidebar = () => {
  ...
  const iconMapping = {
    ...
    "Manage Task": <TaskIcon className="menu-icon" />,
    "Status Report": <AssessmentIcon className="menu-icon" />,
    "Human Resources": <DeviceHub className="menu-icon" />,
    "Lunch Management": <LunchDining className="menu-icon" />,
  };
  ...
  return (
    ...
    <div className="menu-icon-text dashboard active d-flex align-items-center gap-2">
            <DashboardOutlined className="menu-icon" style={{ fontSize: "30px" }} />
            <Link to="/hrms/" className="menu-link"> 
              Dashboard
            </Link>
          </div>
